...
@Plugin(service=ServiceNameConstants.WorkflowNodeStep,name= NomadNodeStepPlugin.SERVICE_PROVIDER_NAME)
@PluginDescription(title="NomadNodeStep", description="My WorkflowNodeStep plugin description")
public class NomadNodeStepPlugin implements NodeStepPlugin, Describable{

    public static final String SERVICE_PROVIDER_NAME = "nomad-node-step";  
